...
str(disdata)
#Need to change Location, WN, and Disability type to Factors
as_factor(disdata$LocationAbbr)
#64 levels
as_factor(disdata$Response)
#14 levels
as_factor(disdata$Stratification1)
#8 levels
...
(Possibe directions of interest include "Does veteran status predispose to a certain disability", "Are certain disabilities more common in specific states", etc.)
